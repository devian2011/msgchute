...
func (m *MockMessageRepo) GetTransports(ctx context.Context) ([]string, error) {
	args := m.Called(ctx)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockMessageRepo) GetSenders(ctx context.Context) ([]string, error) {
	args := m.Called(ctx)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockMessageRepo) GetTemplateCodes(ctx context.Context) ([]string, error) {
	args := m.Called(ctx)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockMessageRepo) GetRecipients(ctx context.Context, search string) ([]string, error) {
